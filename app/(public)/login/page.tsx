  ...
  return (
    <div >
      <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 bg-slate-400">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm px-4 py-4 rounded-xl bg-white">
          <Image
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <p className="mt-10 text-center text-sm text-gray-500">
              Não tem conta? 
              <a href="#" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500"> Faça seu registro aqui</a>
            </p>
          </div>
        </div>
      </div>
